			...
			<div class="container">
				...
				<div class="container">
					<div class="row gallery-item">
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail1.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail1.png);"></div>
							</a>
						</div>
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail2.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail2.png);"></div>
							</a>
						</div>
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail3.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail3.png);"></div>
							</a>
						</div>
						<div class="col-md-6">
							<a href="resources/img/tranding_item/nail4.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail4.png);"></div>
							</a>
						</div>
						<div class="col-md-6">
							<a href="resources/img/tranding_item/nail5.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail5.png);"></div>
							</a>
						</div>
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail6.png"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail6.png);"></div>
							</a>
						</div>
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail7.jpg"
								class="img-pop-up img-gal"">
								<div class=" single-gallery-image"
									style="background: url(resources/img/tranding_item/nail7.jpg);"></div>
							</a>
						</div>
						<div class="col-md-4">
							<a href="resources/img/tranding_item/nail8.jpg"
								class="img-pop-up img-gal">
								<div class="single-gallery-image"
									style="background: url(resources/img/tranding_item/nail8.jpg);"></div>
							</a>
						</div>
					</div>
					<div class="load_more_btn text-center">
						<a href="#" class="btn_3" style="margin-top: 50px">더보기</a>
					</div>
				</div>
			</div>
		</div>
