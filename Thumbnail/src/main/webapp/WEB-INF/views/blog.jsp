            ...
            <div class="blog_left_sidebar">
              ...
              <article class="blog_item">
                <div class="blog_item_img">
                  <img
                    class="card-img rounded-0"
                    src="resources/img/blog/single_blog_2.png"
                    alt=""
                  />
                  <a href="#" class="blog_item_date">
                    <h3>15</h3>
              ...
              <article class="blog_item">
                <div class="blog_item_img">
                  <img
                    class="card-img rounded-0"
                    src="resources/img/blog/single_blog_3.png"
                    alt=""
                  />
                  <a href="#" class="blog_item_date">
                    <h3>15</h3>
              ...
              <article class="blog_item">
                <div class="blog_item_img">
                  <img
                    class="card-img rounded-0"
                    src="resources/img/blog/single_blog_4.png"
                    alt=""
                  />
                  <a href="#" class="blog_item_date">
                    <h3>15</h3>
              ...
              <article class="blog_item">
                <div class="blog_item_img">
                  <img
                    class="card-img rounded-0"
                    src="resources/img/blog/single_blog_5.png"
                    alt=""
                  />
                  <a href="#" class="blog_item_date">
                    <h3>15</h3>
            ...
            <div class="blog_right_sidebar">
              ...
              <aside class="single_sidebar_widget popular_post_widget">
                ...
                <div class="media post_item">
                  <img src="resources/img/post/9.jpg" alt="post" class="recent_img" />
                  <div class="media-body">
                    <a href="single-blog.do">
                ...
                <div class="media post_item">
                  <img src="resources/img/post/11.jpg" alt="post" class="recent_img" />
                  <div class="media-body">
                    <a href="single-blog.do">
                ...
                <div class="media post_item">
                  <img src="resources/img/post/15.jpg" alt="post" class="recent_img" />
                  <div class="media-body">
                    <a href="single-blog.do">
                ...
                <ul class="instagram_row flex-wrap">
                  ...
                  <li>
                    <a href="#">
                      <img
                        class="img-fluid"
                        src="resources/img/post/post_10.png"
                        alt=""
                      />
                    </a>
                  </li>
